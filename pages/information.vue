...
<div class="container-info">
  ...
  <div class="containerT1">
    ...
    <div class="text">
      ...
      <p>校舎建て替え工事のため正門が使用できないので、ご来場の方は西門(正門を過ぎて右折)から入場してください。列の先頭・最後尾への誘導については、赤いTシャツを着た文化祭準備委員にお尋ねください。</p>
      <p>また、一列での整列にご協力くださいますようお願い申し上げます。なお西日暮里駅が工事中のため、駅の出口付近が一部通行止めとなっている箇所がございます。ご注意ください。</p>
    </div>
  </div>
