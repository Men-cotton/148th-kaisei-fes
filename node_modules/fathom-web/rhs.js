...
exports.OutwardRhs = exports.InwardRhs = undefined;
exports.out = out;

var _utilsForFrontend = require('./utilsForFrontend');

const TYPE = 1; // The right-hand side of a rule
...
class InwardRhs {
    constructor(calls = [], max = Infinity, types) {
        ...
        this._types = new _utilsForFrontend.NiceSet(types); // empty set if unconstrained
    }
    ...
    fact(fnode, leftType) {
        ...
        const result = {};
        let haveSubfacts = 0;
        for (let call of (0, _utilsForFrontend.reversed)(this._calls)) {
