...
class Fnode {
    ...
    scoreFor(type) {
        this._computeType(type);
        return (0, _utilsForFrontend.sigmoid)(this._ruleset.weightedScore(this.scoresSoFarFor(type)) + (0, _utilsForFrontend.getDefault)(this._ruleset.biases, type, () => 0));
    }
    ...
    _typeRecordForSetting(type) {
        return (0, _utilsForFrontend.setDefault)(this._types, type, () => ({ score: new Map() }));
    }
    ...
    _typeRecordForGetting(type) {
        return (0, _utilsForFrontend.getDefault)(this._types, type, () => ({ score: new Map() }));
    }
    ...
    _computeType(theType) {
        if (!this._types.has(theType)) {
            ...
            this._ruleset.get((0, _side.type)(theType));
        }
    }
}
exports.Fnode = Fnode;