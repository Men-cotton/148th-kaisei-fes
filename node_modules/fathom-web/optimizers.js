...
exports.Sample = exports.Corpus = exports.Run = exports.Annealer = undefined;

var _fs = require('fs');

var _path = require('path');

var _utilsForBackend = require('./utilsForBackend');
    ...
    anneal() {
        ...
        for (let i = 0; i < this.COOLING_STEPS; i++) {
            ...
            for (let j = 0; j < this.STEPS_PER_TEMP; j++) {
                ...
                let newCost = (0, _utilsForFrontend.setDefault)(seenSolutions, newSolution.toString(), () => this.solutionCost(newSolution));
...
class Corpus {
    ...
    constructor() {
        ...
        for (const sampleDir of (0, _utilsForBackend.dirsIn)(baseFolder)) {
            this.samples.set(sampleDir, this.sampleFromPath((0, _path.join)(baseFolder, sampleDir)));
        }
    }
...
class Sample {
    ...
    constructor(sampleDir) {
        const html = (0, _fs.readFileSync)((0, _path.join)(sampleDir, 'source.html'), { encoding: 'utf8' });
        /**
         * The DOM of the HTML document I represent
         */
        this.doc = (0, _utilsForBackend.staticDom)(html);
        /**
         * The name of the folder this sample came from
         */
        this.name = (0, _path.basename)(sampleDir);
    }
}
